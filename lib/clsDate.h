...
class clsDate{
	...
	static bool IsDate1BeforeDate2(clsDate Date1, clsDate Date2){
		return  ((Date1.GetYear() < Date2.GetYear()) ? true : ((Date1.GetYear() ==
		Date2.GetYear()) ? (Date1.GetMonth() < Date2.GetMonth() ? true : (Date1.GetMonth() == Date2.GetMonth()
	...
	clsDate IncreaseDateByOneMonth(clsDate& Date) {
		...
		// be 28/2/2022
		short NumberOfDaysInCurrentMonth = NumberOfDaysInAMonth(Date.GetMonth(),
		Date.GetYear());
    ...
    static string DateTime(){
        ...
        string DateTime = DateToString(clsDate())+ " "+ Time;
